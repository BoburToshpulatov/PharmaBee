...
<PharmaBeeWrapper>
  ...
  <PharmaBeeTop>
    <PharmaBeeTopLeft>
      <h2>BEST PHARMACY</h2>
      <h1>PharmaBee help you find solutions for your health</h1>
    ...
    <PharmaBeeTopRight><img src={woman} alt="woman-img" /></PharmaBeeTopRight>
  </PharmaBeeTop>
  <PharmaBeeBottom>
    <PharmaBeeBottomMini>
      <Hexogon>
...
Morbi scelerisque volutpat sed viverra nulla Interdum mia bibendum velit sapien scelerisque. Dictum quam tincidunt nec feugiat augue vel tincidunt. Etiam pretium nec diam rhoncus. gravida in turpis cursus. Nunc, sed fringilla tortor, iaculis eget eget felis dictum.</p>
 ...
 <MiddleWrapper>
  ...
  <BrandsLogos>
    <BrandLogosLeft>
      <h1>Eget lacinia libero metus maecenas commodo</h1>
