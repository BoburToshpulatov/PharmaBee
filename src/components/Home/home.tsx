...
import { BrandLogosLeft, BrandLogosRight, BrandLogosRightMini, Brands, BrandsLogos, Categories, CounterMedicine, CounterMedicineBottom, CounterMedicineBottomMini, CounterMedicineTop, CounterMedicineTopLeft, CounterMedicineTopRight, Covid, CovidBtn, CovidMini1, CovidMini2, CovidMini2Inf, CovidMini3, CovidMini3Instructions, FloatingButton, Hexogon, MiddleWrapper, Mini3Instructions, MiniBoxBottom, MiniBoxTop, MotherAndBaby, MotherAndBabyTop, PharmaBeeBottom, PharmaBeeBottomMini, PharmaBeeTop, PharmaBeeTopLeft, PharmaBeeTopRight, PharmaBeeWrapper, PriceSale, ProductsLocation, PromotionInf, PromotionInfMini, PromotionInfMiniBottom , ReadMore, Testimonials, TestimonialsPeople, TestimonialsPeopleLeft, TestimonialsPeopleRight, WhiteBtn } from './homeStyle'
...
<PharmaBeeWrapper>
  ...
  <PharmaBeeTop>
    <PharmaBeeTopLeft>
      <h2>BEST PHARMACY</h2>
      <h1 className='float _anim-items _anim-no-hide'>PharmaBee help you find solutions for your health</h1>
      <p>A lectus ac pulvinar tincidunt accumsan ullamcorper
      dolor acsed facilisis hac molestie aliquam blandit.</p>
      <ProductsLocation>
      <FloatingButton 
    ...
    <PharmaBeeTopRight className='float _anim-items _anim-no-hide'><img src={woman} alt="woman-img" /></PharmaBeeTopRight>
  </PharmaBeeTop>
  <PharmaBeeBottom>
    ...
    <CounterMedicine>
      <CounterMedicineTop>
        <CounterMedicineTopLeft>
          <h1 className='float _anim-items _anim-no-hide'>Over the Counter Medicine</h1>
          <p>Lectus pulvinar tincidunt accumsan ullamcorper dolor acsed facilisis molestie aliquam.</p>
        </CounterMedicineTopLeft>
  ...
  <Covid>
    ...
    <CovidMini2>
      <CovidMini2Inf>
        ...
        <p>Eget lacinia libero, metus maecenas commodo vel auctor. Augue enim libero in gravida. Diam quisque convallis quis tellus feugiat. <br /><br />

Morbi scelerisque volutpat sed viverra nulla Interdum mia bibendum velit sapien scelerisque. Dictum quam tincidunt nec feugiat augue vel tincidunt. Etiam pretium nec diam rhoncus. gravida in turpis cursus. Nunc, sed fringilla tortor, iaculis eget eget felis dictum.</p>
        <ReadMore
 ...
 <MiddleWrapper>
  ...
  <BrandsLogos>
    <BrandLogosLeft>
      <h1 className='float _anim-items _anim-no-hide'>Eget lacinia libero metus maecenas commodo</h1>
      <p>Augue enim libero in gravida. Diam quisque convallis quis tellus feugiat. Morbi scelerisque volutpat <br /><br />

Sed viverra nulla Interdum mia bibendum velit sapien scelerisque ictum quam tincidunt nec feugiat augue vel tincidunt. Etiam pretium diam rhoncus. gida in turpis cursus. Nunc, sed fringilla tortor iaculis eget</p>
    </BrandLogosLeft>
  <BrandLogosRight>
    <BrandLogosRightMini>
    ...
    <img src={logo6} alt="logo-icon" /></BrandLogosRightMini>
    <BrandLogosRightMini>
    <img src={logo7} alt="logo-icon" />
    <img src={logo8} alt="logo-icon" />
    <img src={logo9} alt="logo-icon" /></BrandLogosRightMini>
  </BrandLogosRight>
  </BrandsLogos>
  </Brands>
