...
import { AddressBox, AddressBoxInf, AddressBoxInfMini,EmailSubscription, FloatingButton, FooterBottom, FooterMain, FooterTop, LogoBox, MainWrapper, MediaIcons, MenuColumn, MenuColumnText, PolicyIcons, PolicyIconsMini } from './styled'
...
<FooterBottom>
  <img style={{position:'absolute',alignSelf:'flex-start'}} src={polygon} alt="Pharmacy-icon" />
  <MainWrapper>
    <LogoBox>
      <img src={logo} alt="logo-icon" />
      <p>A lectus ac pulvinar tincidunt accumsan ulla corper dolor at lectus ac sed facilis isaclect Molestieuam ublandit nibh vulputatctus in sit egestas in dolor purus tincidunt. </p>
    </LogoBox>
    <AddressBox>
  ...
  <PolicyIcons>
    <PolicyIconsMini>
      ...
      <MediaIcons>
        <button><img src={facebook} alt="media-icon" /></button>
        <button><img src={twitter} alt="media-icon" /></button>
        <button><img src={instagram} alt="media-icon" /></button>
        <button><img src={youtube} alt="media-icon" /></button>
      </MediaIcons>
    </PolicyIconsMini>
  </PolicyIcons>
</FooterBottom>
