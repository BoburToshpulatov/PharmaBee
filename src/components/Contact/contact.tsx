...
import { BackgroundImg, BackgroundText, ContactMain, ContactUs, ContactUsLeft, ContactUsLeftEmail, ContactUsRight, HomeDirect, MapContainer, MapContainerLeft, MapContainerLeftBottom, MapContainerLeftBottomMini, MapContainerRight, MsgBtn } from './contactStyle'
...
const ContactComponent = () => {
  ...
  return (
    ...
    <ContactMain>
      <img style={{position:'absolute',alignSelf:'flex-start'}} src={polygon} alt="polygon" />
      <MapContainer>
        <MapContainerLeft>
          <h2>CONTACT US</h2>
          <h1>Let's Get Started</h1>
          <p>Risus turpis blandit tellus orci a. Vel quam lobortis ut nibh pretium eu leo. Blandit nibh pharetra viverra velit celerisque sit id volutpat pulvinar Nunc feugiat odio.</p>
          <MapContainerLeftBottom>
            <MapContainerLeftBottomMini>
              <img style={{width:'21px',height:'21px',marginLeft:'-1px'}} src={window} alt="window-icon" />
        ...
        <MapContainerRight>
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d317750.5275089563!2d-0.161821!3d51.523746!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604b900d26973%3A0x4291f3172409ea92!2z0JvQvtC90LTQvtC90YHQutC40Lkg0JPQu9Cw0Lc!5e0!3m2!1sru!2sus!4v1734441199875!5m2!1sru!2sus"  width="578" height="400" style={{border:'none',borderRadius:'20px'}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </MapContainerRight>
      </MapContainer>
